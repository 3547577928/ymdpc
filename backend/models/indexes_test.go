...
func TestEnsureIndexes(t *testing.T) {
	...
	if err := db.AutoMigrate(&User{}, &Post{}, &Tag{}, &Comment{}, &PostLike{}, &Follow{}, &Category{}, &Favorite{}, &CommentLike{}, &Notification{}, &Report{}, &AdminLog{}, &Setting{}, &PostRevision{}, &ForumTopic{}, &ForumTopicImage{}, &ForumReply{}, &ForumTopicLike{}, &ForumReplyLike{}); err != nil {
		t.Fatal(err)
	}
