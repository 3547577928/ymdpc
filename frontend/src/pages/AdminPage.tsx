...
export function AdminPage() {
  ...
  const openEdit = async (post: PostSummary) => {
    ...
    try {
      ...
      setDraft({ title: detail.title, slug: detail.slug, summary: detail.summary, content: detail.content, coverImage: detail.coverImage, tags: detail.tags, status: detail.status, featured: detail.featured })
    } catch (reason) {
      setShowEditor(false)
